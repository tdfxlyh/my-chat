...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 1);\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\nvar _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 2));\nvar _vuex = __webpack_require__(/*! vuex */ 42);\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }\nvar _default = {\n  data: function data() {\n    return {\n      // 自动滚动吗，0不滚动，1滚动\n      isGunDong: 1,\n      scrollTop: 999999,\n      myInput: \"\",\n      receiver_user_id: 0,\n      receiver_user_name: \"\",\n      message_list: [],\n      // 下拉刷新是否被触发\n      triggeredPull: false,\n      // 定时执行\n      timeOut1: 0\n    };\n  },\n  computed: _objectSpread({}, (0, _vuex.mapGetters)([])),\n  onLoad: function onLoad(e) {\n    var _this = this;\n    this.receiver_user_id = parseInt(e.other_user_id, 10);\n    var opt_type = 1;\n    var receiver_user_id = this.receiver_user_id;\n    // 获取聊天信息\n    this.$u.api.Friend.getMessage({\n      opt_type: opt_type,\n      receiver_user_id: receiver_user_id\n    }, {\n      custom: {\n        'auth': true\n      }\n    }).then(function (res) {\n      __f__(\"log\", res, \" at pages/other/chat/chat.vue:80\");\n      if (res.status == 0) {\n        _this.receiver_user_name = res.data.user_name;\n        _this.message_list = res.data.msg_list;\n        uni.setNavigationBarTitle({\n          title: res.data.user_name\n        });\n      } else {\n        uni.showToast({\n          title: \"服务器内部错误\",\n          icon: \"none\"\n        });\n      }\n    });\n  },\n  onShow: function onShow() {\n    this.goBottom();\n    var that = this;\n    that.timeOut1 = setInterval(function () {\n      __f__(\"log\", 1, \" at pages/other/chat/chat.vue:100\");\n      if (that.isGunDong == 1) {\n        var opt_type = 4; // 新消息\n        var receiver_user_id = that.receiver_user_id;\n        var timestamp = 0;\n        if (that.message_list.length > 0) {\n          timestamp = that.message_list[that.message_list.length - 1].timestamp;\n        }\n        // 获取最新消息\n        that.$u.api.Friend.getMessage({\n          opt_type: opt_type,\n          receiver_user_id: receiver_user_id,\n          timestamp: timestamp\n        }, {\n          custom: {\n            'auth': true\n          }\n        }).then(function (res) {\n          __f__(\"log\", res, \" at pages/other/chat/chat.vue:118\");\n          if (res.status == 0) {\n            res.data.msg_list.forEach(function (tmp) {\n              that.message_list.push(tmp);\n            });\n          } else {\n            uni.showToast({\n              title: \"服务器内部错误\",\n              icon: \"none\"\n            });\n          }\n        });\n      }\n    }, 1500);\n  },\n  onHide: function onHide() {\n    __f__(\"log\", 11, \" at pages/other/chat/chat.vue:134\");\n    clearInterval(this.timeOut1);\n  },\n  onUnload: function onUnload() {\n    __f__(\"log\", 22, \" at pages/other/chat/chat.vue:138\");\n    clearInterval(this.timeOut1);\n  },\n  methods: {\n    // 查看聊天记录\n    lookChat: function lookChat(e) {\n      var top = e.target.scrollTop;\n      var height = e.target.scrollHeight;\n      if (height - top > 770) {\n        this.isGunDong = 0;\n      } else {\n        this.isGunDong = 1;\n      }\n    },\n    goBottom: function goBottom(e) {\n      if (this.isGunDong == 1) {\n        this.scrollTop = 999999999 + Math.ceil(Math.random() * 1000);\n      }\n    },\n    // 查看头像\n    toSeeUserImages: function toSeeUserImages(photo) {\n      var that = this;\n      var nowPhoto = photo;\n      var imageList = [nowPhoto];\n      uni.previewImage({\n        current: nowPhoto,\n        urls: imageList,\n        longPressActions: {\n          itemList: ['保存图片'],\n          itemColor: '#417fca',\n          success: function success(data) {\n            var nowphoto = imageList[data.index];\n            that.toDownImages(nowphoto);\n          },\n          fail: function fail(err) {\n            __f__(\"log\", err.errMsg, \" at pages/other/chat/chat.vue:173\");\n          }\n        }\n      });\n    },\n    // 输入文字长度检查\n    longCheck: function longCheck() {\n      if (this.myInput.length == 140) {\n        uni.showToast({\n          title: \"已达到最大长度！\",\n          icon: 'none',\n          mask: false\n        });\n      } else if (this.myInput.length >= 138) {\n        uni.showToast({\n          title: \"注意不要超过140字！\",\n          icon: 'none',\n          mask: false\n        });\n      }\n    },\n    onRefresh: function onRefresh() {\n      var that = this;\n      that.triggeredPull = true;\n      // 获取历史聊天信息\n      var opt_type = 3; // 历史50条\n      var receiver_user_id = that.receiver_user_id;\n      var timestamp = 0;\n      if (that.message_list.length > 0) {\n        timestamp = that.message_list[0].timestamp;\n      }\n      if (timestamp == 0) {\n        return;\n      }\n      this.$u.api.Friend.getMessage({\n        opt_type: opt_type,\n        receiver_user_id: receiver_user_id,\n        timestamp: timestamp\n      }, {\n        custom: {\n          'auth': true\n        }\n      }).then(function (res) {\n        __f__(\"log\", res, \" at pages/other/chat/chat.vue:208\");\n        if (res.status == 0) {\n          res.data.msg_list.reverse();\n          res.data.msg_list.forEach(function (tmp) {\n            that.message_list.unshift(tmp);\n          });\n          setTimeout(function () {\n            that.triggeredPull = false;\n          }, 1000);\n        } else {\n          uni.showToast({\n            title: \"服务器内部错误\",\n            icon: \"none\"\n          });\n        }\n      });\n    },\n    toOptMsg: function toOptMsg(item) {\n      var _this2 = this;\n      if (!item.is_me) {\n        // 只能删除\n        uni.showModal({\n          content: \"是否确定删除\",\n          confirmColor: \"#ff0000\",\n          success: function success(res) {\n            if (res.confirm == true) {\n              // 操作信息\n              _this2.$u.api.Friend.optMessage({\n                opt_type: 2,\n                message_id: item.id\n              }, {\n                custom: {\n                  'auth': true\n                }\n              }).then(function (res) {\n                __f__(\"log\", res, \" at pages/other/chat/chat.vue:242\");\n                if (res.status == 0) {\n                  _this2.reloadData();\n                  uni.showToast({\n                    title: \"删除成功\",\n                    icon: \"none\"\n                  });\n                } else {\n                  uni.showToast({\n                    title: \"服务器内部错误\",\n                    icon: \"none\"\n                  });\n                }\n              });\n            }\n          }\n        });\n        return;\n      }\n      // 自己的可以删除，可以撤回\n      uni.showModal({\n        content: \"选择需要执行的操作\",\n        confirmColor: \"#ff0000\",\n        confirmText: \"删除\",\n        cancelColor: \"#5AC725\",\n        cancelText: \"撤回\",\n        success: function success(res) {\n          var opt_type = 2;\n          var message_id = item.id;\n          if (res.confirm == true) {\n            // 删除\n            opt_type = 2;\n          } else {\n            // 撤回\n            opt_type = 3;\n          }\n          uni.showModal({\n            content: \"是否确定\" + opt_type == 2 ? \"删除\" : \"撤回\",\n            confirmColor: \"#ff0000\",\n            success: function success(res) {\n              if (res.confirm == true) {\n                // 操作信息\n                _this2.$u.api.Friend.optMessage({\n                  opt_type: opt_type,\n                  message_id: message_id\n                }, {\n                  custom: {\n                    'auth': true\n                  }\n                }).then(function (res) {\n                  __f__(\"log\", res, \" at pages/other/chat/chat.vue:290\");\n                  if (res.status == 0) {\n                    _this2.reloadData();\n                    uni.showToast({\n                      title: opt_type == 2 ? \"删除\" : \"撤回\" + \"成功\",\n                      icon: \"none\"\n                    });\n                  } else {\n                    uni.showToast({\n                      title: \"服务器内部错误\",\n                      icon: \"none\"\n                    });\n                  }\n                });\n              }\n            }\n          });\n        }\n      });\n    },\n    reloadData: function reloadData() {\n      var that = this;\n      that.$u.api.Friend.getMessage({\n        opt_type: 2,\n        // 2: 最新n条消息 \n        receiver_user_id: that.receiver_user_id,\n        n: that.message_list.length\n      }, {\n        custom: {\n          'auth': true\n        }\n      }).then(function (res) {\n        __f__(\"log\", res, \" at pages/other/chat/chat.vue:321\");\n        if (res.status == 0) {\n          that.message_list = res.data.msg_list;\n        } else {\n          uni.showToast({\n            title: \"服务器内部错误\",\n            icon: \"none\"\n          });\n        }\n      });\n    },\n    // 发送消息\n    toSendMsg: function toSendMsg() {\n      var that = this;\n      if (that.myInput == \"\") {\n        uni.showToast({\n          title: \"输入不能为空！\",\n          icon: \"none\"\n        });\n        return;\n      }\n      var message_type = 1;\n      var receiver_user_id = that.receiver_user_id;\n      var content = that.myInput;\n      that.$u.api.Friend.addMessage({\n        message_type: message_type,\n        receiver_user_id: receiver_user_id,\n        content: content\n      }, {\n        custom: {\n          'auth': true\n        }\n      }).then(function (res) {\n        __f__(\"log\", res, \" at pages/other/chat/chat.vue:351\");\n        if (res.status != 0) {\n          uni.showToast({\n            title: \"服务器内部错误\",\n            icon: \"none\"\n          });\n          return;\n        }\n        that.myInput = \"\";\n      });\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 40)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///86\n");
